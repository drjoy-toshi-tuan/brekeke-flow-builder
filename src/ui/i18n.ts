...
const DICT: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    dmSubtitleScenarios: 'Chọn kịch bản để mở bản mới nhất, hoặc xem lịch sử phiên bản.',
    ...
    colAppliedVersion: 'Đang áp dụng',
    colVersion: 'Phiên bản',
    dmAppliedBadge: 'Đang áp dụng',
    dmNotApplied: 'Chưa áp dụng',
    dmHistory: 'Lịch sử phiên bản',
    dmOpenLatest: 'Mở bản mới nhất',
  ...
  ja: {
    ...
    dmSubtitleScenarios: 'シナリオを選択すると最新バージョンを開きます。履歴から旧バージョンも確認できます。',
    dmSubtitleVersions: 'シナリオのバージョン一覧（最新が上）。',
    colScenarioCount: 'シナリオ数',
    colLatestVersion: '最新バージョン',
    colAppliedVersion: '適用中',
    colVersion: 'バージョン',
    dmAppliedBadge: '適用中',
    dmNotApplied: '未適用',
    dmHistory: 'バージョン履歴',
    dmOpenLatest: '最新バージョンを開く',
