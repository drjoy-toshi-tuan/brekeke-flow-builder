...
冒頭_アナウンス.prompt={tts_g:医事課入院係をお呼び出ししましたが、回線が混みあっておりお繋ぎできませんでした。AI電話がご用件をお伺いし、3診療日以内に担当者から折り返し電話連絡いたします。}
初診確認.prompt={tts_g:当院でのご受診は初めてですか？}
携帯番号聴取.prompt={tts_g:緊急時の連絡方法として、携帯電話の番号をお伺いしています。携帯電話をお持ちの場合は、番号をおっしゃってください。お持ちでない場合は「持っていない」とおっしゃってください。}
用件聴取_1.prompt={tts_g:ご用件を簡潔におっしゃってください。}
追加用件確認.prompt={tts_g:その他、追加のご用件はございますか？}
用件聴取_2.prompt={tts_g:ご用件を簡潔におっしゃってください。}
通話完了_アナウンス.prompt={tts_g:ご用件を承りました。3診療日以内に担当者から折り返し電話連絡いたします。なお、代表電話は大変こみあっております。当院からの折り返し電話に出られなかった場合でも、必ずこちらから再度ご連絡をしますのでお待ちくださいますようお願い申し上げます。お電話ありがとうございました。}
