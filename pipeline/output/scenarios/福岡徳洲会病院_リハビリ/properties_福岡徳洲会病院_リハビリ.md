...
END_終話_成功.prompt={tts_g:お申込みを受付しました。失礼いたします。}
END_終話_失敗.prompt={tts_g:お申込みを受付しました。失礼いたします。}
冒頭_アナウンス.prompt={tts_g:福岡徳洲会病院通所リハビリテーション専用、AI電話です。}
