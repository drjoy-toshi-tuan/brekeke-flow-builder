// [TZ-PIN] Asia/Tokyo 固定（scaffold が slot 展開時に付与）。Nashorn に Intl が無いため UTC+9h で JST 現在時刻を得る。
function __jstNow(){var d=new Date();return new Date(d.getTime()+(9*60+ d.getTimezoneOffset())*60000);}
// ==================================================================
...
function resolveAndSave(dbValue, readingValue) {
    ...
    var __skipPlay = String($ivr.getObject("__skip_tts") || "") === "1";
    if (finalPrompt && !__skipPlay) {
