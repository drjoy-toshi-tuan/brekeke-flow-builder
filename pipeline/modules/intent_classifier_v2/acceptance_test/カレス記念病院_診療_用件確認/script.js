...
//   {"question_type": "menu", "evidences": [{"name": "kw_予約", "keywords": ["予約", "よやく"], "patterns": [], "negatable": true}, {"name": "kw_変更", "keywords": ["変更", "へんこう", "かえる", "変え"], "patterns": [], "negatable": true}, {"name": "kw_キャンセル", "keywords": ["キャンセル", "取り消し", "とりけし"], "patterns": [], "negatable": true}, {"name": "kw_その他お問い合わせ", "keywords": ["その他お問い合わせ", "お問い合わせ", "問い合わせ", "といあわせ", "質問", "相談"], "patterns": [], "negatable": true}], "events": [], "rules": [{"intent": "予約", "all": ["kw_予約"], "none": ["kw_予約_neg"]}, {"intent": "変更", "all": ["kw_変更"], "none": ["kw_変更_neg"]}, {"intent": "キャンセル", "all": ["kw_キャンセル"], "none": ["kw_キャンセル_neg"]}, {"intent": "その他お問い合わせ", "all": ["kw_その他お問い合わせ"], "none": ["kw_その他お問い合わせ_neg"]}], "numbers": {"1": "予約", "2": "変更", "3": "キャンセル", "4": "その他お問い合わせ"}}      仕様 DATA（spec・hash 対象）:
...
var STEP_NAME = "用件確認";
// @spec-begin
var SPEC = {"question_type": "menu", "evidences": [{"name": "kw_予約", "keywords": ["予約", "よやく"], "patterns": [], "negatable": true}, {"name": "kw_変更", "keywords": ["変更", "へんこう", "かえる", "変え"], "patterns": [], "negatable": true}, {"name": "kw_キャンセル", "keywords": ["キャンセル", "取り消し", "とりけし"], "patterns": [], "negatable": true}, {"name": "kw_その他お問い合わせ", "keywords": ["その他お問い合わせ", "お問い合わせ", "問い合わせ", "といあわせ", "質問", "相談"], "patterns": [], "negatable": true}], "events": [], "rules": [{"intent": "予約", "all": ["kw_予約"], "none": ["kw_予約_neg"]}, {"intent": "変更", "all": ["kw_変更"], "none": ["kw_変更_neg"]}, {"intent": "キャンセル", "all": ["kw_キャンセル"], "none": ["kw_キャンセル_neg"]}, {"intent": "その他お問い合わせ", "all": ["kw_その他お問い合わせ"], "none": ["kw_その他お問い合わせ_neg"]}], "numbers": {"1": "予約", "2": "変更", "3": "キャンセル", "4": "その他お問い合わせ"}};
// @spec-end
