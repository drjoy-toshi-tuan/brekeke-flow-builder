...
var QUESTION_SOURCE = "module:入力_FAQ質問";

var FAQ_NOTE_NAME    = "drjoy.faq";   // FAQ 仮想 DB の Brekeke Note 名 (JSON 配列)。wiring: デプロイ/テストごとに差し替え（drjoy. 固定・サフィックスはシナリオ可変。既定=商談デモ用 drjoy.faq）
