// n_choice — 受診歴(再診/初診) config 充填版（A3 Phase2 調達）
// 正本 modules/n_choice/script.js（engine v4）に「受診歴_再診初診」spec を充填した具体版。
...
if (input === null || input === undefined || input === "") {
    ...
    // @spec-begin
    var KEYWORD_PATTERNS = [{"regex":"再診|前にかかった|通院|かかりつけ|以前","result":"再診"},{"regex":"初診|初めて|はじめて|今回が初","result":"初診"}];
    // @spec-end
    if (result === null) {
