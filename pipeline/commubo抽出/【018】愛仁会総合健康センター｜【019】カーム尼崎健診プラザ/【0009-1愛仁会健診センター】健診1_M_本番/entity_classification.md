# Entity Classification Summary — 愛仁会総合健康センター / 健診

対象 yaml: 5 本

  - `【018】愛仁会総合健康センター｜【019】カーム尼崎健診プラザ/【0009-1愛仁会健診センター】健診1_M_本番/main.yaml`
  - `【018】愛仁会総合健康センター｜【019】カーム尼崎健診プラザ/【0009-1愛仁会健診センター】健診1_M_本番/現在の予約日聴取.yaml`
  - `【018】愛仁会総合健康センター｜【019】カーム尼崎健診プラザ/【0009-1愛仁会健診センター】健診1_M_本番/生年月日聞取り.yaml`
  - `【018】愛仁会総合健康センター｜【019】カーム尼崎健診プラザ/【0009-1愛仁会健診センター】健診1_M_本番/用件聴取.yaml`
  - `【018】愛仁会総合健康センター｜【019】カーム尼崎健診プラザ/【0009-1愛仁会健診センター】健診1_M_本番/連絡先聴取.yaml`
...
| R2_STT_TEMPLATE_REUSE | 50 | STT 辞書 (use_template) |
| R3_STT_KANA_VARIANT | 29 | STT 辞書 (yomi) |
| R4_OPENAI_SYNONYM | 113 | OpenAI 正規化 |
...
### 用件
- STT: 23 surfaces, OpenAI: 44 surfaces
- STT サンプル:
  - `キャンセル` (R2_STT_TEMPLATE_REUSE → hearing_yoken_common)
  - `やめる` (R2_STT_TEMPLATE_REUSE → hearing_yoken_common)
