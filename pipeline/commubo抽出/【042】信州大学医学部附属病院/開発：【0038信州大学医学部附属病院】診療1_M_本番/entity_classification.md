# Entity Classification Summary — 信州大学医学部附属病院 / 開発：【0038信州大学医学部附属病院】診療

対象 yaml: 8 本

  - `【042】信州大学医学部附属病院/開発：【0038信州大学医学部附属病院】診療1_M_本番/main.yaml`
  - `【042】信州大学医学部附属病院/開発：【0038信州大学医学部附属病院】診療1_M_本番/予約日の聞き取り.yaml`
  - `【042】信州大学医学部附属病院/開発：【0038信州大学医学部附属病院】診療1_M_本番/受診歴.yaml`
  - `【042】信州大学医学部附属病院/開発：【0038信州大学医学部附属病院】診療1_M_本番/生年月日聞き取り.yaml`
  - `【042】信州大学医学部附属病院/開発：【0038信州大学医学部附属病院】診療1_M_本番/用件.yaml`
  - `【042】信州大学医学部附属病院/開発：【0038信州大学医学部附属病院】診療1_M_本番/診察券番号聞き取り.yaml`
  - `【042】信州大学医学部附属病院/開発：【0038信州大学医学部附属病院】診療1_M_本番/診療科聞き取り.yaml`
  - `【042】信州大学医学部附属病院/開発：【0038信州大学医学部附属病院】診療1_M_本番/連絡先電話番号聞き取り.yaml`
...
| ルール | 件数 | 行き先 |
| --- | ---: | --- |
| R1_STT_PROPER_NOUN_GROUP | 432 | STT 辞書 (additional_words) |
| R2_STT_TEMPLATE_REUSE | 39 | STT 辞書 (use_template) |
| R3_STT_KANA_VARIANT | 38 | STT 辞書 (yomi) |
...
### 01_00_分岐なし診療科
- STT: 307 surfaces, OpenAI: 0 surfaces
- STT サンプル:
...
### 用件
- STT: 15 surfaces, OpenAI: 55 surfaces
- STT サンプル:
  ...
  - `なくした` (R3_STT_KANA_VARIANT → hearing_yoken_common)
- OpenAI サンプル:
  - `3`
  - `3番`
  - `三`
