...
src/
  ...
  auth/      # AuthProvider, useAuth, config (ALLOWED_DOMAIN), LoginScreen, jwt
  store/     # zustand flowStore: giữ FlowIR + actions
  components/# Toolbar, NodeSettingsPanel
fixtures/    # sample-flow.yaml (dữ liệu test mặc định)
```
